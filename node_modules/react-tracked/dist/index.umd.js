(function (global, factory) {
  ...
  var createContainer = function createContainer(useValue, options) {
    ...
    var StateContext = useContextSelector.createContext(null);
    var UpdateContext = react.createContext(null);
    ...
    var useSelector = function useSelector(selector) {
      ...
      && useContextSelector.useContext(StateContext) === null) {
    ...
    var useUpdate = concurrentMode ? function () {
      if (typeof process === 'object' && process.env.NODE_ENV !== 'production' && (useContextSelector.useContext(StateContext) === null || react.useContext(UpdateContext) === null)) {
        throw new Error('Please use <Provider>');
      }
    ...
    : function () {
      if (typeof process === 'object' && process.env.NODE_ENV !== 'production' && react.useContext(UpdateContext) === null) {
        throw new Error('Please use <Provider>');
      }
