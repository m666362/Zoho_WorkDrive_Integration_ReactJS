...
var PickersArrowSwitcherButton = styled(IconButton, {
  ...
  return _extends({}, styleProps.hidden && {
    visibility: 'hidden'
  });
});
var PickersArrowSwitcher = /*#__PURE__*/React.forwardRef(function PickersArrowSwitcher(props, ref) {
  ...
  var RightArrowIcon = components.RightArrowIcon || ArrowRightIcon; // TODO: convert to simple assignment after the type error in defaultPropsHandler.js:60:6 is fixed
  ...
  return /*#__PURE__*/_jsxs(PickersArrowSwitcherRoot, _extends({
    ...
    children: [/*#__PURE__*/_jsx(PickersArrowSwitcherButton, _extends({
      ...
      styleProps: _extends({}, styleProps, leftArrowButtonProps, {
        hidden: isLeftHidden
      }),
      ...
      styleProps: _extends({}, styleProps, rightArrowButtonProps, {
