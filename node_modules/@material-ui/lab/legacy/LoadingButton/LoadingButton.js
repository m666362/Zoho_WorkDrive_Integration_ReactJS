...
var useUtilityClasses = function useUtilityClasses(styleProps) {
  var loading = styleProps.loading,
      loadingPosition = styleProps.loadingPosition,
...
var rootShouldForwardProp = function rootShouldForwardProp(prop) {
  return prop !== 'styleProps' && prop !== 'theme' && prop !== 'sx' && prop !== 'as' && prop !== 'classes';
};
...
var LoadingButtonRoot = styled(Button, {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    return _extends({}, styles.root, styles.startIconLoadingStart && _defineProperty({}, "& .".concat(loadingButtonClasses.startIconLoadingStart), styles.startIconLoadingStart), styles.endIconLoadingEnd && _defineProperty({}, "& .".concat(loadingButtonClasses.endIconLoadingEnd), styles.endIconLoadingEnd));
  }
})(function (_ref3) {
  ...
  return _extends(_defineProperty({}, "& .".concat(loadingButtonClasses.startIconLoadingStart, ", & .").concat(loadingButtonClasses.endIconLoadingEnd), {
    ...
    opacity: 0
  }), styleProps.loadingPosition === 'center' && _defineProperty({
...
var LoadingButtonLoadingIndicator = styled('div', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return _extends({}, styles.loadingIndicator, styles["loadingIndicator".concat(capitalize(styleProps.loadingPosition))]);
  }
})(function (_ref5) {
