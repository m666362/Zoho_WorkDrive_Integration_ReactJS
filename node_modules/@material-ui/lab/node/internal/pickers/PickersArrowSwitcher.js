...
const PickersArrowSwitcherButton = (0, _styles.styled)(_IconButton.default, {
  ...
  styleProps
}) => (0, _extends2.default)({}, styleProps.hidden && {
  visibility: 'hidden'
}));
const PickersArrowSwitcher = /*#__PURE__*/React.forwardRef(function PickersArrowSwitcher(props, ref) {
  ...
  const RightArrowIcon = components.RightArrowIcon || _ArrowRight.default; // TODO: convert to simple assignment after the type error in defaultPropsHandler.js:60:6 is fixed
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(PickersArrowSwitcherRoot, (0, _extends2.default)({
    ...
    children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(PickersArrowSwitcherButton, (0, _extends2.default)({
      ...
      styleProps: (0, _extends2.default)({}, styleProps, leftArrowButtonProps, {
        hidden: isLeftHidden
      }),
      ...
      styleProps: (0, _extends2.default)({}, styleProps, rightArrowButtonProps, {
