...
const LoadingButtonRoot = (0, _styles.styled)(_Button.default, {
  ...
  overridesResolver: (props, styles) => {
    return (0, _extends2.default)({}, styles.root, styles.startIconLoadingStart && {
...
const LoadingButtonLoadingIndicator = (0, _styles.styled)('div', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.loadingIndicator, styles[`loadingIndicator${(0, _utils2.capitalize)(styleProps.loadingPosition)}`]);
  }
})(({
  theme,
  styleProps
