...
const LoadingButtonRoot = styled(Button, {
  ...
  overridesResolver: (props, styles) => {
    return _extends({}, styles.root, styles.startIconLoadingStart && {
...
const LoadingButtonLoadingIndicator = styled('div', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return _extends({}, styles.loadingIndicator, styles[`loadingIndicator${capitalize(styleProps.loadingPosition)}`]);
  }
})(({
  theme,
  styleProps
