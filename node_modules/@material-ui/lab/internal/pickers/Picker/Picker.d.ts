...
declare function Picker({ autoFocus, className, date, DateInputProps, isMobileKeyboardViewOpen, onDateChange, openTo, orientation, showToolbar, toggleMobileKeyboardView, ToolbarComponent, toolbarFormat, toolbarPlaceholder, toolbarTitle, views, ...other }: PickerProps): JSX.Element;
